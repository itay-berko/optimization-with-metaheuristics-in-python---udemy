...
for i in range(gen):
    ...
    for j in range(int(pop/2)): # range(int(pop/2))
        ...
        # add the child 1 to list + the cost for child 1
        ...
        # add the child 2 to list + the cost for child 2
